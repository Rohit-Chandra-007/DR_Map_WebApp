...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String code,  String identifier,  String regionCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Province() when $default != null:
return $default(_that.name,_that.code,_that.identifier,_that.regionCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String code,  String identifier,  String regionCode)  $default,) {final _that = this;
switch (_that) {
case _Province():
return $default(_that.name,_that.code,_that.identifier,_that.regionCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String code,  String identifier,  String regionCode)?  $default,) {final _that = this;
switch (_that) {
case _Province() when $default != null:
return $default(_that.name,_that.code,_that.identifier,_that.regionCode);case _:
  return null;
